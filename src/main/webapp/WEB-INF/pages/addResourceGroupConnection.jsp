...
<div class="container body-content">
    ...
    <form:form commandName="resourceGroupConnection" cssClass="form-horizontal" >
        <div class="control-group">
            <label class="control-label">Resource:</label>
            <div class="controls">
                <form:select path="resourceId" items="${resources}" itemLabel="projectName" itemValue="resourceId"/>
            </div>
            <div class="controls">
                <form:input cssClass="input-xlarge" path="resourceGroupId" value="" type="hidden"/>
            </div>
        </div>
        <br>
