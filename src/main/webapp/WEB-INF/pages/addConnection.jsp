...
<div class="container body-content">
    <h1>User Group</h1>
    <form:form commandName="connection" cssClass="form-horizontal" id = "LoginForm">
        <div class="control-group">
            <label class="control-label">User Group:</label>
            <div class="controls">
                <form:select path="userGroupId" items="${userGroups}" itemLabel="groupName" itemValue="userGroupId"/>
            </div>
            <label class="control-label">Resource Group:</label>
            <div class="controls">
                <form:select path="resourceGroupId" items="${resourceGroups}" itemLabel="groupName" itemValue="resourceGroupId"/>
            </div>
            <label class="control-label">Full Permission:</label>
            <div class="controls">
                <form:checkbox path="fullPermission"/>
            </div>
            <div class="controls">
                <form:input cssClass="input-xlarge" path="userResourceConnectionId" type="hidden"/>
            </div>
        </div>
        <br>
